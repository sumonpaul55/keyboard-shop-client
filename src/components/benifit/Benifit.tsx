    ...
    return (
        <section className='bg-secondary py-8 md:py-16'>
            <div className="container mx-auto">
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-5 md:gap-10 mt-10'>
                    <div className="py-4 bg-white rounded shadow">
                        <div className="p-4">
                            <div className='size-20 border rounded-full flex items-center justify-center mx-auto'>
